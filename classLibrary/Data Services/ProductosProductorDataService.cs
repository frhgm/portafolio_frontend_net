...
{
    public class ProductosProductorDataService
    {
        ...
        /// </summary>
        public ProductosProductorDataService()
        {
        ...
        /// <summary>
        /// Ejecuta sp_get_all_productos para recuperar los productos de todos los productores
        /// </summary>
        /// <returns>Devuelve una lista de productos del los productores en el sistema</returns>

        public async Task<ProductosProductor> TraerProductosDeProductores()
        {
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync($"{_baseAddress}sp_get_all_producto_productor/", new { }); //puedo recibir
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    {
                        var productosProductores = JsonSerializer.Deserialize<ProductosProductor>(content, _jsonSerializerOptions);
